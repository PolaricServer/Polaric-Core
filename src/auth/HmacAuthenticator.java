...
public class HmacAuthenticator implements Authenticator {
     ...
     * If expired, remove the session-key and the user-login. 
     */
           ...
           throws CredentialsException 
    {
        ...
        if (rmac==null && nonce==null)
            throwsException("Authentication header info is missing");
        ...
        /* Check hmac auth */
        Optional<String> bodyHash = ctx.webContext().getRequestAttribute("bodyHash");
         ...
         * peer servers. The key was found in the keyfile. 
         */
        if (ui==null) 
    ...
    /**
     * Generate an authentication string to use in a URL. Consists of: 
     *  - userid
     *  - nonce: Base64 encoded 8 byte random number. 
